      ...
      <h3 class="text-center">Update Requester Details</h3>
            ...
            if(($_REQUEST['r_login_id'] == "") || ($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "")){
                $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2">*Fill All Fields</div>' ;
                  ...
                  if($conn ->query($sql)==TRUE){
                    ...
                    $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert">Unable to Updated .</div>' ;   
                  }
              }
        }
       ?>
       <form action="" method="post">
         <div class="form-group">
           ...
           <input class= "form-control" type="text" name="r_login_id" id="r_login_id" value="<?php if(isset($row['r_login_id'])){echo $row['r_login_id'];} ?>" readonly>
         </div>
         <div class="form-group">
           <label for="r_name"> Name</label>
           <input class= "form-control" type="text" name="r_name" id="r_name" value="<?php if(isset($row['r_name'])){echo $row['r_name'];} ?>" >
         </div>
         <div class="form-group">
           <label for="r_email">Email </label>
           <input class= "form-control" type="email" name="r_email" id="r_email" value="<?php if(isset($row['r_email'])){echo $row['r_email'];} ?>" >
         </div>
